      ...
      <div class="mt-12 text-center relative overflow-hidden py-8 bg-green-100">
        ...
        <div class="relative z-10 max-w-6xl mx-auto px-14">
          ...
          <div class="grid grid-cols-1 md:grid-cols-6 gap-6">
            <div class="group bg-blue-50/80 backdrop-blur-lg border border-blue-200 rounded-lg shadow-lg p-4 hover:border-blue-400 hover:shadow-blue-300 transition-all duration-300 flex flex-col items-center">
              <div class="relative mb-4">
                <div class="absolute -inset-1 bg-blue-200/40 rounded-full blur-md group-hover:bg-blue-300/50"></div>
                <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 text-blue-700 relative" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
